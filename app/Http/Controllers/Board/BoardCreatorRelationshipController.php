...
class BoardCreatorRelationshipController extends Controller
{
    private $service;
    ...
    {
        return $this->service->fetchRelationship($board, 'creator');
    }
    ...
    public function update(JSONAPIRelationshipRequest $request, Board $board)
    {
        ...
        return $this->service->updateToOneRelationship($board, 'creator', $request->input('data.id'));
    }
}
